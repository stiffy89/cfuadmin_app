    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#fff" }}>
            <View style={{ flexDirection: 'row', justifyContent: "space-between", alignItems: 'center', marginTop: 20, marginBottom: 10 }}>
                ...
                <CustomText variant='titleMediumBold'>{displayName}</CustomText>
                <IconButton style={{display: showSharing ? 'flex' : 'none'}} icon={() => <CustomIcon name="Share" color={!localFilePath ? theme.colors.surfaceDisabled : theme.colors.primary} size={25} />} disabled={!localFilePath} size={20} onPress={shareFile} />
            </View>
            {pdfSource &&
                (<Pdf
